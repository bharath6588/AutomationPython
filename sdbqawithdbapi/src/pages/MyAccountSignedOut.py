...
from sdbqawithdbapi.src.SeleniumExtended import SeleniumExtended
from sdbqawithdbapi.src.pages.locators.MyAccountSignedOutLocator import MyAccountSignedOutLocator
from sdbqawithdbapi.src.helpers.config_helpers import get_base_url
...
class MyAccountSignedOut(MyAccountSignedOutLocator):
    ...
    def go_to_my_account(self):
        ...
        #my_account_url = "http://demostore.supersqa.com" + self.endpoint
